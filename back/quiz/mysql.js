const mysqlQuiz = [
  {
    ...
    모든 데이터 베이스 표시: show database; 
    데이터베이스의 모든 테이블 확인: show tables from my_dabase`,
  ...
  },
  {
    ...
    insert into my_table (name, age, email) values ('cloudcoke', 27, 'cloudcoke.dev@gmail.com');`,
  ...
  },
  {
    ...
    select name, age from my_table where name='cloudcoke';`,
  ...
  },
  {
    ...
    # name 필드에 cloud라는 문자열이 포함되는 데이터 출력
    select * from my_table where name like '%cloud%';
    # name 필드에 cloud라는 문자열로 시작되는 데이터 출력
    select * from my_table where name like 'cloud%';
    # name 필드에 coke라는 문자열로 끝나는 데이터 출력
    select * from my_table where name like '%coke';
    # name 필드에 p로 시작하고 i로 끝나는 5글자 문자열이 있는 데이터 출력
    select * from my_table where name like 'p___i';`,
  ...
  },
  {
    ...
    update my_table set email='pepsi@gmail.com' where email like '%pepsi%';`,
  ...
  },
  {
    ...
    # column 추가 
    alter table my_table add column level enum('easy', 'middle', 'hard') default 'easy';
    # column 데이터 유형 변경
    alter table my_table modify column level int;
    # column 삭제
    alter table my_table drop column level;
    # column 이름 변경 및 데이터 유형 변경
    alter table my_table change column name nickname varchar(50);
    # 테이블 이름 변경
    alter table my_table rename to hello_table;`,
  ...
  },
  {
    ...
    delete from my_table where name='cloudcider'`,
  ...
  },
  {
    ...
    prompt: `두 개 이상의 테이블 사이의 공통 열을 기반으로 데이터를 결합하는 데 사용하는 명령어 입니다.
    join의 default 값은 inner join입니다.
