const sqlQuiz = [
  ...
  },
  {
    ...
    exam: "insert 명령어를 사용해서 my_database의 my_table에 name은 pepsi, age는 125, email은 pepsi.sns@gmail.com인 행을 삽입해 주세요. [소문자로 작성해 주세요.]",
  ...
  },
  {
    ...
    exam: "my_database의 my_table에 대한 모든 필드와 레코드를 * 기호를 사용해 확인해 보세요. [소문자로 작성해 주세요.]",
  ...
  },
  {
    ...
    exam: "select 명령어와 where 명령어를 함께 사용하여 my_database의 my_table 테이블에서 name이 cloudcoke인 행을 모두 출력해 보세요. [소문자로 작성해 주세요.]",
    answer: "select * from my_table where name='cloudcoke';",
    setting: "",
    hint: "",
    difficulty: "middle",
    category: "sql",
  },
  {
    ...
    exam: "my_database의 my_table 테이블을 age 필드를 기준으로 내림차순으로 정렬해 보세요. [소문자로 작성해 주세요.]",
  ...
  },
  {
    ...
    exam: "my_database의 my_table 테이블에서 email이 gmail.com으로 끝나는 email들을 모두 출력해 보세요. [소문자로 작성해 주세요.]",
  ...
  },
  {
    ...
    exam: "update where 절만 사용해서 my_database의 my_table 테이블에서 name이 cloudcoke인 레코드를 cloudcider로 변경해 보세요. ",
  ...
  },
  {
    ...
    exam: "hello 데이터 베이스의 world 테이블의 이름을 welcome으로 변경해 주세요. [소문자로 작성해 주세요.]",
